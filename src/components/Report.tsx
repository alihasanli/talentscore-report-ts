...
const Report = forwardRef<HTMLDivElement, {}>((props, ref) => {
  const data = {
    sport: {
      text: 'Sport skills', 
      color: '#09959A', 
      value: 10,
      rateText: [
        {min: 0, max: 20, result: 'limited'},
        {min: 21, max: 40, result: 'below average'},
        {min: 41, max: 60, result: 'average'},
        {min: 61, max: 80, result: 'solid'},
        {min: 81, max: 100, result: 'exceptional'},
      ]
    }, 
    education: { 
      text: 'Education',
      ...
      rateText: [
        ...
        {min: 21, max: 40, result: 'below average'},
        {min: 41, max: 60, result: 'average'},
        {min: 61, max: 80, result: 'above average'},
        {min: 81, max: 100, result: 'excellent'},
      ]
    }, 
    program: {
      text: 'Program skills', 
      ...
      value: 15,
      rateText: [
        {min: 0, max: 20, result: 'basic'},
        {min: 21, max: 40, result: 'below average'},
        {min: 41, max: 60, result: 'average'},
        {min: 61, max: 80, result: 'competent'},
        {min: 81, max: 100, result: 'advanced'},
      ]
    }, 
    work: {
      ...
      rateText: [
        {min: 0, max: 20, result: 'limited'},
        {min: 21, max: 40, result: 'decent'},
        {min: 41, max: 60, result: 'moderate'},
        {min: 61, max: 80, result: 'solid'},
        {min: 81, max: 100, result: 'extensive'},
      ]
    }, 
    special: {
      text: 'Special talent', 
      ...
      rateText: [
        {min: 0, max: 20, result: 'limited'},
        {min: 21, max: 40, result: 'average'},
        {min: 41, max: 60, result: 'promising'},
        {min: 61, max: 80, result: 'outstanding'},
        {min: 81, max: 100, result: 'extraordinary'},
      ]
    }, 
    language: {
      ...
      value: 86,
      rateText: [
        {min: 0, max: 20, result: 'minimal'},
        {min: 21, max: 40, result: 'below average'},
        {min: 41, max: 60, result: 'average'},
        {min: 61, max: 80, result: 'proficient'},
        {min: 81, max: 100, result: 'exceptional'},
      ]
    },
  }
  ...
  const getText = (arg: any) => {
    return (
      arg.rateText.map((elem:any) => (
        (arg.value >= elem.min && arg.value <= elem.max) && elem.result 
      ))
    )
  }
    ...
    <div className='report' ref={ref}>
      ...
      <div className='report-body'>
        ...
        <div className='report-part-3'>
          ...
          <p className='report-part3-text'>{name}'s talent percentiles show his <span className='report-part3-bold-text'>{getText(special)} performance in special talents · {special.value}%, {getText(work)} work experience · {work.value}%, {getText(education)} education · {education.value}%, {getText(language)} language skills · {language.value}%, {getText(program)} program skills · {program.value}%, and a {getText(sport)} percentile in sports successes · {sport.value}%.</span></p>
        </div>
